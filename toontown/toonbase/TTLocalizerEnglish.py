...
OptionNames = {
    ...
    "archipelago-textsize": "Chat History Text Size",
    'boss-alerts': "Cog Boss Attack Alerts",
    'bk-warning': "Low Logic Hint Warning",
    "archipelago-log-bg": "Chat Panel Background",
    "archipelago-chat-opacity": "Panel Opacity",
    "archipelago-chat-width": "Panel Width",
    "archipelago-chat-height": "Panel Height",
    "archipelago-chat-theme": "Panel Accent Color",
